...
## Oplus Athena Commands
คำสั่งสำหรับปิด/เปิด oplus.athena (ตัวการที่ฆ่า background process):

ปิด oplus.athena:
```bash
su
pm disable-user --user 0 com.oplus.athena
```

เปิด oplus.athena:
```bash
su
pm enable com.oplus.athena
```
## Mac Desktop
