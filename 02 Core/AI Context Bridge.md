...
- recovery notes แบบ archive ให้เปิดเฉพาะตอนแกนหลักยังไม่พอ
...
5. ถ้าบริบทยังบางจริง ๆ ค่อยเปิด [[Recovered Context Summary - 2026-05-27]]
6. ตอบสั้น ๆ ด้วย active state + next step
